        ...
        <div class="card col-span-12 pb-2 lg:col-span-5 xl:col-span-6">
          ...
          <div class="scrollbar-sm flex space-x-3 overflow-x-auto px-4 pb-3 sm:px-5">
            <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
              <div class="flex flex-col items-center space-y-3 text-center">
                <div class="h-16 w-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                  <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="images/y5kKP4uBpQHw.jpg" alt="image">
                </div>
                <div>
              ...
              <div class="mt-5 flex justify-center space-x-2">
                <button class="btn h-8 w-8 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
            ...
            <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
              <div class="flex flex-col items-center space-y-3 text-center">
                <div class="h-16 w-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                  <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="images/SNmMxDWN0BvP.jpg" alt="image">
                </div>
                <div>
                  <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                    Konnor Guzman
            ...
            <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
              <div class="flex flex-col items-center space-y-3 text-center">
                <div class="h-16 w-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                  <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="images/z0QwBJmCateS.jpg" alt="image">
                </div>
                <div>
                  <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                    Katrina West
            ...
            <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
              <div class="flex flex-col items-center space-y-3 text-center">
                <div class="h-16 w-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                  <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="images/rYvd6p5WeFVw.jpg" alt="image">
                </div>
                <div>
                  <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                    Henry Curtis
        ...
        <div class="col-span-12 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:col-span-7 lg:gap-6 xl:col-span-6">
            ...
            <div class="mt-5 space-y-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/SIrhJJD75Luu.svg" alt="flag">
                  <p>Instagram</p>
                </div>
                <div class="flex items-center space-x-2">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/1cYta1ISGRWO.svg" alt="flag">
                  <p>Facebook</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/zD3XXFBwjpuX.svg" alt="flag">
                  <p>Youtube</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/aQr0E8YrsAMe.svg" alt="flag">
                  <p>Pinterest</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/ExDBQNuhdHgp.svg" alt="flag">
                  <p>Discord</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/jLIESIBOzoL5.svg" alt="flag">
                  <p>TikTok</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/J5dfEycuhMPO.svg" alt="flag">
                  <p>Twitter</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/mIzdFEJhpFeh.svg" alt="flag">
                  <p>Tumblr</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
          ...
          <div class="card px-4 pb-5 sm:px-5">
            ...
            <div class="mt-5 space-y-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/hsweymlj6HTl.svg" alt="flag">
                  <p>Australia</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/eW8ZFlIQeNza.svg" alt="flag">
                  <p>Brazil</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/SvIM6Jr1gff7.svg" alt="flag">
                  <p>China</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/LsFLpX97r0QR.svg" alt="flag">
                  <p>India</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/raWjq3rF9viM.svg" alt="flag">
                  <p>Italy</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/1LgT0UWhwTJr.svg" alt="flag">
                  <p>Japan</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/gjQ0HQwVnTPC.svg" alt="flag">
                  <p>Russia</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <img class="h-6 w-6" src="fonts/GjBUVfp34GFi.svg" alt="flag">
                  <p>Spain</p>
                </div>
                <div class="flex items-center space-x-2">
                  <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <tbody>
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/y5kKP4uBpQHw.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/q08hff3v0Y6O.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/RvgT4LI72RpU.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/rYvd6p5WeFVw.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/hw79VKyNUgmV.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/z0QwBJmCateS.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/4r84Z1AJWIgO.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/ANE6XQnurFxi.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/SNmMxDWN0BvP.jpg" alt="avatar">
                        </div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="avatar h-9 w-9">
                          <img class="mask is-squircle" src="images/RYZsjL9S6JwE.jpg" alt="avatar">
                        </div>
